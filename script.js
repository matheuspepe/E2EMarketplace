...
function seedIfEmpty() {
  ...
  (async () => {
    ...
    // Products (5)
    produtos = [
      { id: crypto.randomUUID(), nome: 'Smartphone 128GB', categoria: 'Eletrônicos', preco: 1799.90, estoque: 25, descricao: 'Tela 6.5", câmera dupla, bateria 5000mAh', imagem: 'https://via.placeholder.com/400x300/4A90E2/FFFFFF?text=Smartphone', ativo: true, fornecedorId: fornecedores[0].id },
      { id: crypto.randomUUID(), nome: 'Notebook 15" i5', categoria: 'Informática', preco: 3499.00, estoque: 12, descricao: '8GB RAM, SSD 256GB, Windows 11', imagem: 'https://via.placeholder.com/400x300/7ED321/FFFFFF?text=Notebook', ativo: true, fornecedorId: fornecedores[0].id },
      ...
      { id: crypto.randomUUID(), nome: 'Travesseiro Ortopédico', categoria: 'Casa', preco: 149.90, estoque: 44, descricao: 'Espuma viscoelástica, antiácaro', imagem: 'https://via.placeholder.com/400x300/50E3C2/FFFFFF?text=Travesseiro', ativo: true, fornecedorId: fornecedores[1].id },
    ];
